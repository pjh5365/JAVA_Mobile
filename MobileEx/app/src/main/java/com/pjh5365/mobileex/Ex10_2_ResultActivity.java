...
public class Ex10_2_ResultActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView picResult = (ImageView) findViewById(R.id.picresult);
        ...
        tv0.setText(imageName[result]);
        picResult.setImageResource(imageFileId[resultIndex]);
